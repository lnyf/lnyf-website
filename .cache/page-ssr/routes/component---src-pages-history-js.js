"use strict";
exports.id = "component---src-pages-history-js";
exports.ids = ["component---src-pages-history-js"];
exports.modules = {
...
/***/ "./src/pages/history.js?export=default":
/*!*********************************************!*\
  !*** ./src/pages/history.js?export=default ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_StyledImage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/StyledImage */ "./src/components/StyledImage.js");
...
const TimelineContainer = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__TimelineContainer"
})(["position:relative;max-width:1200px;margin:0 auto;padding:60px 20px;@media (min-width:768px){padding:80px 40px;}"]);
const TimelineLine = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__TimelineLine"
})(["position:absolute;left:50%;top:0;bottom:0;width:3px;background:", ";transform:translateX(-50%);z-index:1;opacity:0.9;@media (max-width:767px){left:30px;width:2px;}"], ({
  theme
}) => theme.palette.secondary1);
const TimelineItem = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__TimelineItem"
})(["position:relative;margin-bottom:120px;min-height:150px;&:last-child{margin-bottom:0;}@media (max-width:767px){padding-left:60px;margin-bottom:100px;min-height:120px;}@media (min-width:1200px){margin-bottom:140px;min-height:180px;}"]);
const TimelineDot = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__TimelineDot"
})(["position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:18px;height:18px;border-radius:50%;background:", ";z-index:3;box-shadow:0 0 0 4px ", ",0 0 0 6px ", "33;@media (max-width:767px){left:30px;width:14px;height:14px;}@media (min-width:1200px){width:20px;height:20px;}"], ({
  theme
}) => theme.palette.secondary1, ({
  theme
}) => theme.palette.background, ({
...
const HorizontalConnector = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__HorizontalConnector"
})(["position:absolute;", " top:50%;width:50px;height:3px;background:", ";transform:translateY(-50%);z-index:2;@media (max-width:767px){left:44px;right:auto;width:25px;height:2px;}@media (min-width:1200px){width:60px;}"], ({
  isEven,
  toYear
}) => {
  if (toYear) {
    // Connector to year (left side when isEven, right side when not)
    return isEven ? "left: calc(50% + 9px); right: auto;" : "right: calc(50% + 9px); left: auto;";
  } else {
    // Connector to content (right side when isEven, left side when not)
    return isEven ? "right: calc(50% + 9px); left: auto;" : "left: calc(50% + 9px); right: auto;";
  }
}, ({
  theme
}) => theme.palette.secondary1);
const YearContainer = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__YearContainer"
})(["position:absolute;", " top:50%;transform:translateY(-50%);width:calc(50% - 120px);padding:0;text-align:", ";@media (max-width:767px){position:relative;left:auto;right:auto;top:auto;transform:none;width:100%;margin-bottom:20px;text-align:left;}@media (min-width:1200px){", " width:calc(50% - 140px);}"], ({
  isEven
}) => isEven ? "left: calc(50% + 70px);" : "right: calc(50% + 70px);", ({
  isEven
}) => isEven ? "left" : "right", ({
  isEven
}) => isEven ? "left: calc(50% + 80px);" : "right: calc(50% + 80px);");
const TimelineContent = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__TimelineContent"
})(["position:absolute;", " top:50%;transform:translateY(-50%);width:calc(50% - 120px);padding:0;text-align:", ";display:", ";flex-direction:", ";gap:", ";align-items:flex-start;@media (max-width:767px){position:relative;left:auto;right:auto;top:auto;transform:none;width:100%;margin-top:20px;text-align:left;flex-direction:column;gap:15px;}@media (min-width:1200px){", " width:calc(50% - 140px);gap:", ";}"], ({
  isEven
}) => isEven ? "right: calc(50% + 70px);" : "left: calc(50% + 70px);", ({
  isEven
}) => isEven ? "right" : "left", ({
  hasImage
}) => hasImage ? "flex" : "block", ({
  isEven,
  hasImage
}) => hasImage && isEven ? "row-reverse" : "row", ({
  hasImage
}) => hasImage ? "25px" : "0", ({
  isEven
}) => isEven ? "right: calc(50% + 80px);" : "left: calc(50% + 80px);", ({
  hasImage
}) => hasImage ? "30px" : "0");
const YearLabel = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "history__YearLabel"
})(["font-size:2.2rem;font-weight:800;color:", ";margin-bottom:0;letter-spacing:0.02em;line-height:1.2;@media (max-width:767px){font-size:1.8rem;}@media (min-width:1200px){font-size:2.5rem;}"], ({
  theme
}) => theme.palette.secondary1);
const ChapterTitle = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "history__ChapterTitle"
})(["font-size:2rem;font-weight:800;color:", ";margin-bottom:10px;margin-top:0;line-height:1.2;letter-spacing:0.01em;@media (max-width:767px){font-size:1.6rem;}@media (min-width:1200px){font-size:2.2rem;}"], ({
  theme
}) => theme.palette.secondary1);
const Description = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "history__Description"
})(["line-height:1.7;color:", ";margin-top:6px;font-size:1.2rem;font-weight:400;opacity:0.95;@media (max-width:767px){font-size:1.05rem;}@media (min-width:1200px){font-size:1.25rem;}"], ({
  theme
}) => theme.palette.secondary1);
const TextContent = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__TextContent"
})(["flex:1;min-width:0;"]);
const TimelineImageWrapper = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "history__TimelineImageWrapper"
})(["flex-shrink:0;width:", ";min-width:", ";max-width:", ";margin-top:0;margin-bottom:0;border-radius:8px;overflow:hidden;border:2px solid ", ";padding:4px;background:", ";@media (max-width:767px){width:100%;min-width:auto;max-width:100%;margin-top:15px;margin-bottom:10px;}@media (min-width:1200px){width:", ";max-width:", ";}"], ({
  hasText
}) => hasText ? "45%" : "100%", ({
  hasText
}) => hasText ? "250px" : "auto", ({
...
const TimelineImage = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_StyledImage__WEBPACK_IMPORTED_MODULE_4__["default"]).withConfig({
  displayName: "history__TimelineImage"
})(["width:100%;height:auto;border-radius:4px;display:block;object-fit:cover;"]);
const ImageCaption = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "history__ImageCaption"
})(["margin-top:10px;font-style:italic;color:", ";opacity:0.95;font-size:0.95rem;line-height:1.6;"], ({
  theme
}) => theme.palette.secondary1);
const HistoryPage = ({
  data
  ...
  const timeline = _text__WEBPACK_IMPORTED_MODULE_7__["default"].history.timeline || [];
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Seo__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    title: "Our History"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TimelineContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TimelineLine, null), timeline.map((item, index) => {
    const isEven = index % 2 === 1;
    const hasImage = item.image && imgDataMap[item.image];
    const imageData = hasImage ? (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_10__.getImage)(imgDataMap[item.image]) : null;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_6__["default"], {
      ...
      delay: index * 100,
      threshold: 0.2
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TimelineItem, {
      isEven: isEven
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TimelineDot, null), (item.year || item.period) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(HorizontalConnector, {
      isEven: isEven,
      toYear: true
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(YearContainer, {
      isEven: isEven
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(YearLabel, {
      variant: "h5"
    }, item.year || item.period))), (item.title || item.description || hasImage) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TimelineContent, {
      isEven: isEven,
      hasImage: hasImage && imageData
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TextContent, null, item.title && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ChapterTitle, {
      variant: "h3"
    }, item.title), item.description && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Description, {
      variant: "p"
    }, item.description)), hasImage && imageData && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TimelineImageWrapper, {
      hasText: item.title || item.description
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TimelineImage, {
      image: imageData,
      alt: item.imageCaption || item.title
    }), item.imageCaption && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageCaption, {
      variant: "caption"
    }, item.imageCaption))))));
  }))));
};
const query = "164491429";
...
;
//# sourceMappingURL=component---src-pages-history-js.js.map
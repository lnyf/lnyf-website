...
})(["height:0px;padding-bottom:125%;width:100%;position:relative;transform-style:preserve-3d;box-sizing:border-box;&.flipped{.front{transform:rotateY(180deg);}.back{transform:rotateY(0deg);}}"]);
const Back = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "FlipCard__Back"
})(["height:100%;width:100%;box-sizing:border-box;background:$new-white;position:absolute !important;border-radius:10px;border:", ";backface-visibility:hidden;transform-style:preserve-3d;transition:-webkit-transform ease 500ms;transition:transform ease 500ms;background:$new-white;transform:rotateY(-180deg);padding:5px;font-size:10vw;background-color:", ";color:", ";display:flex;flex-direction:column;justify-content:flex-start;overflow-y:auto;", ""], ({
  theme
}) => theme.decoration.borderHover, ({
  theme
}) => theme.palette.primarybackground, ({
  theme
}) => theme.palette.primaryfont, ({
  clickable,
  theme
}) => {
...
const ImageThumbnail = (0,styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_components_StyledImage__WEBPACK_IMPORTED_MODULE_1__["default"]).withConfig({
  displayName: "FlipCard__ImageThumbnail"
})(["height:0px;padding-bottom:125%;width:100%;box-sizing:border-box;display:block !important;background:$new-white;position:absolute !important;border-radius:10px;overflow:hidden;backface-visibility:hidden;transform-style:preserve-3d;transition:-webkit-transform ease 500ms;transition:transform ease 500ms;z-index:2;transform:rotateY(0deg);> div:first-child{display:none !important;}picture,img,[data-placeholder-image],[data-main-image]{position:absolute !important;top:0;left:0;width:100% !important;height:100% !important;object-fit:cover;object-position:center center;}"]);

/* && doubles the class specificity so these beat the base Typography variant */
const SecTitle = (0,styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_2__["default"]).withConfig({
  displayName: "FlipCard__SecTitle"
})(["&&{padding-top:5%;padding-bottom:1.5%;font-size:13px;line-height:15px;letter-spacing:0.04em;@media (min-width:800px){font-size:15px;line-height:17px;}}"]);
const Answer = (0,styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_2__["default"]).withConfig({
  displayName: "FlipCard__Answer"
})(["&&{font-family:\"Open Sans\",sans-serif;font-size:11px;line-height:15px;font-weight:400;text-transform:none;letter-spacing:0.01em;@media (min-width:800px){font-size:12.5px;line-height:17px;}}"]);
class FlipCard extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  constructor(props) {
    super(props);
    this.flip = () => {
      this.setState({
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CardContainer, {
      onClick: this.flip,
      className: "card-container" + (this.state.flipped ? " flipped" : "")
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageThumbnail, {
      image: this.props.image,
      clickable: "true",
      alt: this.props.alt,
      className: "front"
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Back, {
      className: "back",
      clickable: "true"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SecTitle, {
      variant: "subtitle"
    }, "Majors"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Answer, {
      variant: "caption2"
    }, this.props.major)), this.props.zodiac && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SecTitle, {
      variant: "subtitle"
    }, "Zodiac"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Answer, {
      variant: "caption2"
    }, this.props.zodiac)), this.props.talent && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SecTitle, {
      variant: "subtitle"
    }, "Hidden talent"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Answer, {
      variant: "caption2"
    }, this.props.talent)), this.props.character && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SecTitle, {
      variant: "subtitle"
    }, "Favorite character"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Answer, {
      variant: "caption2"
    }, this.props.character)), this.props.facts && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SecTitle, {
      variant: "subtitle"
    }, "What LNYF means to me:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Answer, {
      variant: "caption2"
    }, this.props.facts))));
  }
}
...
/* harmony import */ var _components_InnerPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/InnerPage */ "./src/components/InnerPage.js");
/* harmony import */ var _text__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../text */ "./src/text.js");
/* harmony import */ var _utils_convertImgArrToMap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/convertImgArrToMap */ "./src/utils/convertImgArrToMap.js");
/* harmony import */ var gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! gatsby-plugin-image */ "./node_modules/gatsby-plugin-image/dist/gatsby-image.module.js");
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! styled-components */ "./node_modules/styled-components/dist/styled-components.esm.js");
...
/* harmony import */ var _components_FlipCard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/FlipCard */ "./src/components/FlipCard.js");
/* harmony import */ var _components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/FadeInOnScroll */ "./src/components/FadeInOnScroll.js");
...
const Grid = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "people__Grid"
})(["display:grid;grid-gap:20px;margin-bottom:20px;@media (min-width:500px){grid-template-columns:1fr 1fr;}@media (min-width:900px){grid-template-columns:1fr 1fr;}@media (min-width:1140px){grid-template-columns:1fr 1fr 1fr;margin-bottom:70px;}"]);
const StyledHeader = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "people__StyledHeader"
...
const ImageContainer = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "people__ImageContainer"
})(["display:flex;flex-direction:column;align-items:center;text-align:center;"]);
const StyledTitle = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "people__StyledTitle"
})(["margin-bottom:40px;:not(:first-child){margin-top:80px;}"]);
const PeoplePage = ({
  data
}) => {
  const {
  ...
  const imgDataMap = (0,_utils_convertImgArrToMap__WEBPACK_IMPORTED_MODULE_4__["default"])(nodes);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Seo__WEBPACK_IMPORTED_MODULE_8__["default"], {
    title: "People"
    ...
    title: "People"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_7__["default"], {
    direction: "up",
    delay: 0
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledTitle, {
    variant: "h4"
  }, "Board of Directors")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Grid, null, _text__WEBPACK_IMPORTED_MODULE_3__["default"].people.bod.map((p, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: i,
    direction: "up",
    delay: i * 10
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FlipCard__WEBPACK_IMPORTED_MODULE_6__["default"], {
    image: (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_10__.getImage)(imgDataMap[p.image]),
    alt: p.name + " portrait",
    major: p.major,
    zodiac: p.zodiac,
    talent: p.talent,
    ...
    variant: "subtitle"
  }, p.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"], {
    variant: "caption"
  }, p.position))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_7__["default"], {
    direction: "up",
    delay: 0
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledTitle, {
    variant: "h4"
  }, "Communications Committee")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Grid, null, _text__WEBPACK_IMPORTED_MODULE_3__["default"].people.comm.map((p, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: i,
    direction: "up",
    delay: i * 100
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FlipCard__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    variant: "h4"
  }, "Development Committee")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Grid, null, _text__WEBPACK_IMPORTED_MODULE_3__["default"].people.dev.map((p, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: i,
    direction: "up",
    delay: i * 100
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FlipCard__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    variant: "h4"
  }, "Performance Committee")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Grid, null, _text__WEBPACK_IMPORTED_MODULE_3__["default"].people.perf.map((p, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_7__["default"], {
    key: i,
    direction: "up",
    delay: i * 100
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FlipCard__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PeoplePage);
const query = "1466464121";

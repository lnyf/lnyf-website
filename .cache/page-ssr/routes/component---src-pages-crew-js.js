"use strict";
exports.id = "component---src-pages-crew-js";
exports.ids = ["component---src-pages-crew-js"];
exports.modules = {
...
/***/ "./src/pages/crew.js?export=default":
/*!******************************************!*\
  !*** ./src/pages/crew.js?export=default ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Section = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "crew__Section"
})(["margin-bottom:40px;"]);
const Card = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "crew__Card"
...
const TwoColumnGrid = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "crew__TwoColumnGrid"
...
const StyledHeader = (0,styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "crew__StyledHeader"
})(["margin-bottom:15px;color:", ";"], ({
  theme
}) => theme.palette.secondary1);
const InfoText = (0,styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "crew__InfoText"
})(["line-height:1.6;margin-bottom:20px;"]);
const InfoTextNoMargin = (0,styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "crew__InfoTextNoMargin"
})(["line-height:1.6;margin-bottom:0 !important;margin-top:0 !important;"]);
const StyledLink = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].a.withConfig({
  displayName: "crew__StyledLink"
})(["text-decoration:none;color:inherit;"]);
const IconContainer = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "crew__IconContainer"
})(["font-size:3rem;margin-bottom:15px;color:", ";"], ({
  theme
}) => theme.palette.secondary1);
const FormContainer = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "crew__FormContainer"
...
const FormIframe = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].iframe.withConfig({
  displayName: "crew__FormIframe"
})(["width:100%;min-height:800px;border:none;display:block;"]);
const FormButtonContainer = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "crew__FormButtonContainer"
...
const CrewPage = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_3__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Seo__WEBPACK_IMPORTED_MODULE_4__["default"], {
    title: "Stage Crew & Ushers Applications"
    ...
    title: "Stage Crew & Ushers Applications"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Section, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_6__["default"], {
    direction: "up",
    delay: 0,
    threshold: 0.15
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(InfoText, {
    variant: "p",
    style: {
      textAlign: 'center',
      marginBottom: '30px'
    }
  }, "Interested in being part of LNYF 2026 behind the scenes? We're looking for dedicated volunteers to join our usher or stage crew teams!"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TwoColumnGrid, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_6__["default"], {
    direction: "up",
    delay: 0,
    threshold: 0.2
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Card, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledHeader, {
    variant: "h4"
  }, "Usher Application"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(InfoText, {
    variant: "p"
  }, "Join our usher team and help create a welcoming experience for our audience. Ushers assist with seating, provide directions, and ensure a smooth show experience for all attendees."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FormButtonContainer, {
    style: {
      marginTop: 'auto',
      paddingTop: '20px'
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledLink, {
    href: _text__WEBPACK_IMPORTED_MODULE_7__["default"].links.usherForm,
    target: "_blank",
    rel: "noopener noreferrer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Button__WEBPACK_IMPORTED_MODULE_1__["default"], null, "Open Usher Form in New Tab"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FormContainer, {
    style: {
      marginTop: '20px'
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FormIframe, {
    src: _text__WEBPACK_IMPORTED_MODULE_7__["default"].links.usherForm,
    ...
    variant: "h4"
  }, "Stage Crew Application"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(InfoText, {
    variant: "p"
  }, "Be part of the magic behind the scenes! Stage crew members help with act changes and props during rehearsals and performances."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FormButtonContainer, {
    style: {
      marginTop: 'auto',
      paddingTop: '20px'
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledLink, {
    href: _text__WEBPACK_IMPORTED_MODULE_7__["default"].links.stageCrewForm,
    target: "_blank",
    rel: "noopener noreferrer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Button__WEBPACK_IMPORTED_MODULE_1__["default"], null, "Open Stage Crew Form in New Tab"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FormContainer, {
    style: {
      marginTop: '20px'
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FormIframe, {
    src: _text__WEBPACK_IMPORTED_MODULE_7__["default"].links.stageCrewForm,
    ...
    variant: "h4"
  }, "Questions?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(InfoTextNoMargin, {
    variant: "p"
  }, "If you have any questions about the application process or what's involved in being part of the crew, please reach out to us at", " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledLink, {
    href: "mailto:wu.lnyf@gmail.com",
    style: {
      color: 'inherit',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CrewPage);
...
;
//# sourceMappingURL=component---src-pages-crew-js.js.map
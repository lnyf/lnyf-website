...
/***/ "./src/components/ButtonDropdown.js":
/*!******************************************!*\
  !*** ./src/components/ButtonDropdown.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Wrapper = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "ButtonDropdown__Wrapper"
...
const ButtonDropdown = ({
  ...
  }, rest), value, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", {
    className: "fas fa-angle-down"
  })), open && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Dropdown, null, options.map((o, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(DropdownItem, {
    onClick: () => {
...
/* harmony import */ var _components_ButtonDropdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/ButtonDropdown */ "./src/components/ButtonDropdown.js");
/* harmony import */ var _components_ImageOverlay__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/ImageOverlay */ "./src/components/ImageOverlay.js");
/* harmony import */ var _components_InnerPage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/InnerPage */ "./src/components/InnerPage.js");
...
/* harmony import */ var _components_StyledImage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/StyledImage */ "./src/components/StyledImage.js");
...
/* harmony import */ var _components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/FadeInOnScroll */ "./src/components/FadeInOnScroll.js");
/* harmony import */ var _text__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../text */ "./src/text.js");
/* harmony import */ var _utils_convertImgArrToMap__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/convertImgArrToMap */ "./src/utils/convertImgArrToMap.js");
...
const Grid = styled_components__WEBPACK_IMPORTED_MODULE_12__["default"].div.withConfig({
  displayName: "gallery__Grid"
})(["display:grid;grid-gap:20px;margin-bottom:20px;@media (min-width:500px){grid-template-columns:1fr 1fr;}@media (min-width:800px){grid-template-columns:1fr;}@media (min-width:1000px){grid-template-columns:1fr 1fr;}"]);
const ImageContainer = styled_components__WEBPACK_IMPORTED_MODULE_12__["default"].div.withConfig({
  displayName: "gallery__ImageContainer"
})(["display:flex;flex-direction:column;align-items:center;text-align:center;"]);
const OverlayImage = (0,styled_components__WEBPACK_IMPORTED_MODULE_12__["default"])(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_13__.GatsbyImage).withConfig({
  displayName: "gallery__OverlayImage"
})(["align-self:center;margin-bottom:20px;"]);
const ImageThumbnail = (0,styled_components__WEBPACK_IMPORTED_MODULE_12__["default"])(_components_StyledImage__WEBPACK_IMPORTED_MODULE_7__["default"]).withConfig({
  displayName: "gallery__ImageThumbnail"
})(["height:0px;padding-bottom:75%;"]);
const StyledLabel = (0,styled_components__WEBPACK_IMPORTED_MODULE_12__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_8__["default"]).withConfig({
  displayName: "gallery__StyledLabel"
})(["margin-bottom:10px;"]);
const MediaLabel = (0,styled_components__WEBPACK_IMPORTED_MODULE_12__["default"])(StyledLabel).withConfig({
  displayName: "gallery__MediaLabel"
})(["margin-top:10px;"]);
const StyledButton = (0,styled_components__WEBPACK_IMPORTED_MODULE_12__["default"])(_components_Button__WEBPACK_IMPORTED_MODULE_1__["default"]).withConfig({
  displayName: "gallery__StyledButton"
})(["margin-right:10px;margin-bottom:5px;"]);
const VideoContainer = styled_components__WEBPACK_IMPORTED_MODULE_12__["default"].div.withConfig({
  displayName: "gallery__VideoContainer"
})(["position:relative;box-sizing:border-box;width:100%;height:0;padding-bottom:60%;border:", ";box-shadow:", ";"], ({
  theme
}) => theme.decoration.border, ({
  theme
}) => theme.decoration.boxShadow);
const Video = styled_components__WEBPACK_IMPORTED_MODULE_12__["default"].iframe.withConfig({
  displayName: "gallery__Video"
})(["position:absolute;height:100%;width:100%;"]);
const GalleryPage = ({
  data
}) => {
  const sortedYears = Object.keys(_text__WEBPACK_IMPORTED_MODULE_10__["default"].gallery).sort((a, b) => b - a);
  const {
    imgData
  } = data;
  const {
  ...
  const imgDataMap = (0,_utils_convertImgArrToMap__WEBPACK_IMPORTED_MODULE_11__["default"])(nodes);
  const {
    0: open,
    1: setOpen
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const {
    0: year,
    1: setYear
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(sortedYears[0]);
  const hasPhotos = "photos" in _text__WEBPACK_IMPORTED_MODULE_10__["default"].gallery[year];
  ...
  const {
    0: media,
    1: setMedia
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initialMedia);
  const {
    0: pic,
    1: setPic
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_5__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Seo__WEBPACK_IMPORTED_MODULE_6__["default"], {
    title: "Gallery"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_InnerPage__WEBPACK_IMPORTED_MODULE_4__["default"], {
    title: "Gallery",
    buttons: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_9__["default"], {
      direction: "up",
      delay: 0
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledLabel, {
      variant: "subtitle"
    }, "Year"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ButtonDropdown__WEBPACK_IMPORTED_MODULE_2__["default"], {
      value: year,
      setValue: setYear,
      ...
      active: true
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MediaLabel, {
      variant: "subtitle"
    }, "Media"), "photos" in _text__WEBPACK_IMPORTED_MODULE_10__["default"].gallery[year] && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledButton, {
      white: true,
      onClick: () => setMedia("photos"),
      active: media === "photos"
    }, "Photo"), "videos" in _text__WEBPACK_IMPORTED_MODULE_10__["default"].gallery[year] && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Button__WEBPACK_IMPORTED_MODULE_1__["default"], {
      white: true,
      onClick: () => setMedia("videos"),
      active: media === "videos"
    }, "Video")))
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Grid, null, _text__WEBPACK_IMPORTED_MODULE_10__["default"].gallery[year][media].map((p, i) => media === "photos" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_9__["default"], {
    key: i,
    direction: "up",
    delay: i * 10
    ...
    image: (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_13__.getImage)(imgDataMap[p.image]),
    alt: p.caption,
    clickable: "true"
  }))) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_9__["default"], {
    key: i,
    direction: "up",
    delay: i * 100
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(VideoContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Video, {
    key: i,
    src: p.link,
  ...
  })))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ImageOverlay__WEBPACK_IMPORTED_MODULE_3__["default"], {
    open: open,
    setOpen: setOpen
  }, pic && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(OverlayImage, {
    image: (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_13__.getImage)(imgDataMap[pic.image]),
    alt: pic.caption,
    objectFit: "contain"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Typography__WEBPACK_IMPORTED_MODULE_8__["default"], {
    variant: "p"
  }, "Caption: ", pic.caption))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GalleryPage);
const query = "992183781";

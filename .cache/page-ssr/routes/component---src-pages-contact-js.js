...
const StyledButton = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(_components_Button__WEBPACK_IMPORTED_MODULE_3__["default"]).withConfig({
  displayName: "contact__StyledButton"
})(["align-self:flex-start;"]);
const ContactForm = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].form.withConfig({
  displayName: "contact__ContactForm"
})(["display:flex;flex-direction:column;"]);
const ContactSubject = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].input.withConfig({
  displayName: "contact__ContactSubject"
})(["box-shadow:", ";border:", ";padding:0 17.5px;font-size:14px;height:35px;margin:10px 0 20px;font-family:\"Open Sans\",sans-serif;@media (min-width:600px){padding:0 25px;font-size:18px;height:50px;}"], ({
  theme
}) => theme.decoration.boxShadow, ({
  theme
}) => theme.decoration.border);
const ContactBody = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].textarea.withConfig({
  displayName: "contact__ContactBody"
})(["resize:none;box-shadow:", ";border:", ";padding:17.5px 17.5px;font-size:14px;margin:10px 0 20px;font-family:\"Open Sans\",sans-serif;@media (min-width:600px){padding:25px 25px;font-size:18px;}"], ({
  theme
}) => theme.decoration.boxShadow, ({
  theme
}) => theme.decoration.border);
const ContactPage = () => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Seo__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    title: "Contact"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ContactForm, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Typography__WEBPACK_IMPORTED_MODULE_2__["default"], {
    variant: "h6"
  }, "Subject:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ContactSubject, {
    value: subject,
    onChange: e => {
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Typography__WEBPACK_IMPORTED_MODULE_2__["default"], {
    variant: "h6"
  }, "Message:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ContactBody, {
    rows: 10,
    value: body,
    onChange: e => {

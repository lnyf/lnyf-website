"use strict";
exports.id = "component---src-pages-performances-js";
exports.ids = ["component---src-pages-performances-js"];
exports.modules = {
...
/***/ "./src/pages/performances.js?export=default":
/*!**************************************************!*\
  !*** ./src/pages/performances.js?export=default ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/FadeInOnScroll */ "./src/components/FadeInOnScroll.js");
...
const StyledHeader = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "performances__StyledHeader"
})(["margin-top:20px;margin-bottom:5px;"]);
const ImageThumbnail = (0,styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_components_StyledImage__WEBPACK_IMPORTED_MODULE_4__["default"]).withConfig({
  displayName: "performances__ImageThumbnail"
})(["height:0px;padding-bottom:60%;margin-bottom:10px;@media (min-width:600px){margin-right:20px;margin-bottom:0;}@media (min-width:800px){margin-right:0px;margin-bottom:10px;}@media (min-width:100px){margin-right:20px;margin-bottom:0;}"]);
const ImageContainer = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "performances__ImageContainer"
})(["flex-basis:0;flex-grow:1;"]);
const PerformanceContent = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "performances__PerformanceContent"
})(["flex-grow:1;flex-basis:0;"]);
const PerformanceContainer = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "performances__PerformanceContainer"
})(["display:flex;margin-bottom:20px;margin-right:100px;flex-direction:column;@media (min-width:600px){flex-direction:row;}@media (min-width:800px){flex-direction:column;}@media (min-width:1000px){flex-direction:row;}"]);
const PerformancesPage = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Seo__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    title: "Performances"
  }, _text__WEBPACK_IMPORTED_MODULE_6__["default"].performances.map((p, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FadeInOnScroll__WEBPACK_IMPORTED_MODULE_8__["default"], {
    key: i,
    direction: "up",
    delay: i * 15
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PerformanceContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageThumbnail, {
    image: (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_10__.getImage)(imgDataMap[p.image]),
    alt: p.title
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PerformanceContent, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledHeader, {
    variant: "h6"
  }, p.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Typography__WEBPACK_IMPORTED_MODULE_5__["default"], null, p.performers.map((performer, index) => {
    const isChoreo = performer.includes("(choreo)");
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
      key: index
    }, isChoreo ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, performer) : performer, index < p.performers.length - 1 && ", ");
  }))))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PerformancesPage);
const query = "1749416798";

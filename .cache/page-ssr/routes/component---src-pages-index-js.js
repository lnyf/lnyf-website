...
})(["width:78vw;background-color:", "26;backdrop-filter:blur(5px);border-radius:20px;box-shadow:", "4D 0px 19px 38px,", "38 0px 15px 12px;transition:all .3s;padding:15px 0;@media (max-width:1000px){width:96vw;}&:hover{transform:scale(1.01);}"], ({
  theme
}) => theme.palette.secondary1, ({
  theme
}) => theme.palette.background, ({
...
})(["width:180px;margin:30px;display:flex;flex-direction:column;justify-content:space-between;padding:25px 15px;min-height:150px;align-items:center;border:2px solid ", ";border-radius:10px;color:", ";box-sizing:border-box;overflow:visible;"], _theme__WEBPACK_IMPORTED_MODULE_10__["default"].font, _theme__WEBPACK_IMPORTED_MODULE_10__["default"].palette.font);
...
})(["text-align:center;display:block;max-width:100%;white-space:normal;word-wrap:break-word;overflow-wrap:break-word;hyphens:auto;line-height:1.3;padding:0 5px;font-size:clamp(18px,3vw,26px);letter-spacing:normal;"]);
...
})(["margin-top:25px;display:flex;align-items:center;flex-direction:column;"]);

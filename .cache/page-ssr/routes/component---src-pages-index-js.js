...
})(["width:78vw;background-color:", "26;backdrop-filter:blur(5px);border-radius:20px;box-shadow:", "4D 0px 19px 38px,", "38 0px 15px 12px;transition:all .3s;@media (max-width:1000px){width:96vw;}&:hover{transform:scale(1.01);}"], ({
  theme
}) => theme.palette.secondary1, ({
  theme
}) => theme.palette.background, ({
...
})(["z-index:1;display:-webkit-box;flex-direction:row;overflow-x:scroll;&::-webkit-scrollbar{width:0.8em;}&::-webkit-scrollbar-track{box-shadow:inset 0 0 6px ", "4D;border-radius:10px;}&::-webkit-scrollbar-thumb{background-color:slategray;opacity:0.6;border-radius:10px;}"], ({
  theme
}) => theme.palette.background);
const EventItem = styled_components__WEBPACK_IMPORTED_MODULE_12__["default"].div.withConfig({
  displayName: "pages__EventItem"
})(["width:180px;margin:30px;display:flex;flex-direction:column;justify-content:space-between;padding:20px 10px;align-items:center;border:2px solid ", ";border-radius:10px;color:", ";"], _theme__WEBPACK_IMPORTED_MODULE_10__["default"].font, _theme__WEBPACK_IMPORTED_MODULE_10__["default"].palette.font);
